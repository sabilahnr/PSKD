...
<body style="background-color: rgb(226, 26, 66);">
    ...
    <div class="container">
        <div class="row">
            <div class="card" style="margin:auto; margin-top:50px; width:25rem;">
                <div class="card-body">
                    ...
                    <form action="ceklog.php" method="POST">
                        ...
                        <div class="form-group mt-4 text-center" style="font-size: 11pt; padding-bottom:10px;">
                            Don't have an account? <a href="daftar.php" class="text-decoration-none" style="font-size:11pt">Register</a>
                        </div>
                    </form>
                </div>
            </div>
            <p class="footer margin-t text-center text-light" style="padding: 20px; ">
                <small style="font-size: 10pt;">V3420057 - V3420060 - V3420067 - V3420068 - V3420069</small>
            </p>
        </div>
    </div>
